...
if nargin > 2 && (strcmpi(method,'R') || strcmpi(method,'r'))
...
system(['R -e ' char(39) 'source("~/Documents/MATLAB/Handy Functions/createFN.R"); createFN(' num2str(ple) ',' num2str(siglength) ')' char(39)])
