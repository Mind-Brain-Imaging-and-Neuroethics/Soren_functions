...
%                                                    Settings.EnvelopeParams); %#ok<ASGLU>
        ...
        [nodeEnv,time_ds] = IRASA_power_timecourse(nodeData,Fs,Settings.frequencyBands{iFreq},'frac',['/home/sorenwt/projects/def-gnorthof/sorenwt/HCP_MEG/Results/IRASAcorr_osci/' Settings.sessionName '/' Settings.sessionName '_IRASA_specs.mat']);
...
%save([sessionName '_specs.mat'],'specs','-v7.3')
