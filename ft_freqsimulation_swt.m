...
% give the user some feedback - commented out by SWT to reduce amount printed to screen in NA_test_sim
...
if strcmp(cfg.method, 'superimposed')
    ...
    %%%%%%% MIXED SUPERIMPOSED OSCILLATORY PLUS FRACTAL BACKGROUND %%%%%%%%
elseif strcmp(cfg.method,'mix_oscifrac') % added by SWT on 11/06/2019
    ...
    data.fsample = cfg.fsample;
    tmpcfg = [];
    data = ft_appenddata(tmpcfg,data,sim_osci);
