...
cfg = []; cfg.dim = tlock{1}.dim; cfg.method = 'montecarlo'; cfg.statistic = statfun;
cfg.correctm = 'cluster'; cfg.parameter = 'pow'; cfg.clusteralpha = 0.025; cfg.clusterstatistic = 'maxsum';
